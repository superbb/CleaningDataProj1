...
```
	4. 	Applied labels to the data set with descriptive variable names. 
		I used the names pulled earlier, but did not break them down further until step 5. 
...
```
	5. 	Find averages for all variables found in step 4 and make data tidy.
		I first grabbed the Subject IDs, gave their column the name "Subject", and cbind-ed it to the main table.
...
```	
		...
		Measurement names without a direction which will add additional "unspec." Given the extra mess this creates, I do not see a reason
